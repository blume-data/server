...
import {APPLICATION_NAME, CLIENT_USER_NAME, REFERENCE_MODEL_NAME, RuleType} from "@ranjodhbirkaur/constants";
...
const EntriesTableComponent = (props: EntriesTableType) => {
    ...
    useEffect(() => {
        ...
        const tabColumns: ColDef[] = [
            ...
            { field: 'isPublished', headerName: 'Published', sortable:false, width: widthOfColumn,},
            { field: 'date', headerName: 'Created at', sortable:false, align: "left",width: widthOfColumn,
