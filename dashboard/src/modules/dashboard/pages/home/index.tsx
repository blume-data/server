                ...
                <Grid container justify={"center"}>
                    <Grid item lg={4} xl={12}>
                        ...
                        <List>
                            ...
                            <ListItem>
                            You can create different application spaces for different applications.
                            </ListItem>
                            <ListItem>
                                Consider it as a wrapper within which you can create different working enviornments
                            </ListItem>
                            <ListItem>
                                Withing different enviornments you can create diffent models and records.
                            </ListItem>
                            <ListItem>
