...
import { LOCAL_STORAGE_ENV, LOCAL_STORAGE_SELECTED_APPLICATION_NAME } from "../../../../utils/constants";
...
export const setApplicationName = (value: string): AppThunk => async (dispatch: ThunkDispatch<any, any, AnyAction>) => {
    ...
    const selectedSpace = getItemFromLocalStorage(LOCAL_STORAGE_SELECTED_APPLICATION_NAME);
