...
export function getNameFields(props: GetNameFields) {
  const { contentModelDisplayName, contentModelName, contentModelDescription } =
    props;
...
export function getPropertyFields(props: GetPropertyNameFields) {
  ...
  const propertyNameFields = () => {
    ...
    if (props.fieldType === SHORT_STRING_FIElD_TYPE) {
      ...
      hello.push({
        ...
        options: [
          ...
          {
            label: `Date European (${dateEuropeReg})`,
            value: DateEuropeRegName,
          },
      ...
      hello.push({
        ...
        inputType: TEXT,
        descriptionText:
          "This message will be sent if the value does not match pattern",
        groupName: FIELD_MATCH_SPECIFIC_PATTERN_GROUP,
      });
      ...
      hello.push({
        ...
        inputType: TEXT,
        descriptionText:
          "Custom message will be sent if the value matches this pattern",
        groupName: FIELD_PROHIBIT_SPECIFIC_PATTERN_GROUP,
      });
    }
    ...
    // Default Value field
    if (
      props.fieldType !== REFERENCE_FIELD_TYPE &&
      fieldType !== JSON_FIELD_TYPE
    ) {
      let inputType = "";
    ...
    if (
      fieldType === SHORT_STRING_FIElD_TYPE ||
      ...
      hello.push({
        ...
        descriptionText:
          fieldType === SHORT_STRING_FIElD_TYPE
            ? "Specify a maximum allowed number of characters"
            : "Specify a maximum allowed value",
      });
      // Min count
      hello.push({
        required: false,
        ...
        descriptionText:
          fieldType === SHORT_STRING_FIElD_TYPE
            ? "Specify a minimum allowed number of characters"
            : "Specify a minimum allowed value",
      });
      ...
      hello.push({
        ...
        placeholder:
          fieldType === SHORT_STRING_FIElD_TYPE
            ? "Character count custom error message"
            : "Allowed value custom error message",
        ...
        label:
          fieldType === SHORT_STRING_FIElD_TYPE
            ? "Character count custom error message"
            : "Allowed value custom error message",
        descriptionText: `Specify a custom error message if ${
          fieldType === SHORT_STRING_FIElD_TYPE ? "characters are" : "value is"
      ...
      hello.push({
        ...
        descriptionText:
          "An entry won't be valid if the field value is not in the list of specified values (Add values separated by comma)",
      });
    }
