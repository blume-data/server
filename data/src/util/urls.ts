...
export const CollectionUrl = `${rootUrl}/:clientUserName/:applicationName/collection`;

export const GetCollectionNamesUrl = `${rootUrl}/:clientUserName/:applicationName/get-collection-names`;
